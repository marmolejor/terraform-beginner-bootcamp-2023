...
class TerraTownsMockServer < Sinatra::Base
  ...
  def find_user_by_bearer_token
    ...
    #the code and the user uuid should be matching for this user
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # to see or to debug what we have inputed into this endpoint
    puts "name #{name}"
    ...
    puts "uuid #{uuid}"
    # will mock save our data to our mock database which is just a global variable
    $home = {
      uuid: uuid,
      name: name,
      town: town,
  ...
  get '/api/u/:user_uuid/homes/:uuid' do
    ...
    content_type :json
    #does the uuid from the home match the one in our mock database?
...
#Thisis what will run the server
